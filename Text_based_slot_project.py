...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enough balance to bet on. Your balance is : ${balance}")
        else:
            break

    print(f"You are betting ${bet} on {lines} number of lines. Total bet is equal to ${total_bet}")
